...
ins.dat <- output_feb2022_dd[which(output_feb2022_dd$prop.insecticide == 0.05),]
plot_R0_Sen_dd(ins.dat, trtprops = c(0,0.6,0.95), fitadj = 1) #Ro plots: default matches Hargrove; R0 declines with wildlife
...
ins.dat <- output_feb2022_dd[which(output_feb2022_dd$prop.insecticide == 0.10),]
a10 <- plot.func(ins.dat, Wn = c(0, 100, 250), fitadj = 1)
ins.dat <- output_feb2022_dd[which(output_feb2022_dd$prop.insecticide == 0.3),]
