...
plot_R0_Sen_wl_dd <- function(df2, Wn, fitadj){
  ...
  p <- pA
  p1 <- p + gghighlight(Vector_no == 1000,  fit.adj == fitadj,   unhighlighted_params = my_par, keep_scales = TRUE)
  p2 <- p + gghighlight(Vector_no == 3000,  fit.adj == fitadj,   unhighlighted_params = my_par, keep_scales = TRUE)
  p3 <- p + gghighlight(Vector_no == 5000,  fit.adj == fitadj,   unhighlighted_params = my_par, keep_scales = TRUE)
